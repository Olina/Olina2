...
class CMGuestbook extends CObject implements IHasSQL 
{
	...
	*/
	public function Init() 
	{
		try 
		{
			...
			$this->session->AddMessage('notice', '<font color="green">Skapade ny databastabell.</font>');
		} 
		catch(Exception$e) 
		{
	...
	*/
	public function Add($entry) 
	{
		...
		$this->session->AddMessage('success', '<font color="green">Lade till ett nytt meddelande.</font>');
	...
	*/
	public function DeleteAll() 
	{
		...
		$this->session->AddMessage('info', '<font color="grey">Tog bort alla meddelanden.</font>');
	}
